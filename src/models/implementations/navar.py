...
class NAVAR(TemporalCausalModel):
    def __init__(self,
                 num_variables: int,
                 kernel_size: int,
                 n_layers: int,
        ...
        """
        super().__init__(num_variables, receptive_field=n_layers * (kernel_size - 1) + 1)
        tcn = DepthwiseSeparableTCN(
