...
class NAVAR_TCN(nn.Module):
    def __init__(self, num_nodes: int, kernel_size: int, n_layers: int, hidden_dim: int, dropout: float = 0.0):
        """
...
if __name__ == '__main__':
    ...
    model = NAVAR_TCN(num_nodes=5, kernel_size=3, n_layers=1, hidden_dim=32, dropout=0.1).to(DEVICE)
