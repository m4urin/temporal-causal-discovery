...
class Config:
    def __init__(self,
                 model: str,  # 'NAVAR' or 'TAMCaD'
                 dataset: str,  # filename of dataset, e.g. '6_nodes_synthetic.pt'
                 hidden_dim, # number of channels per variable
                 kernel_size,
                 n_blocks,
                 n_layers_per_block,
                 dropout,
                 ...
                 aleatoric: bool,
                 epistemic: bool,
                 uncertainty_contributions: bool  # only for 'NAVAR'
                 ):
        self.model = model
